          ...
          <div className="row testimonials">
              ...
              <div className="col-full testimonials__slider">
                  ...
                  <div className="testimonials__slide">
                      <img src="images/avatars/user-01.jpg" alt="Author 1" className="testimonials__avatar"/>
                  ...
                  <div className="testimonials__slide">
                      <img src="images/avatars/user-05.jpg" alt="Author 2" className="testimonials__avatar"/>
                  ...
                  <div className="testimonials__slide">
                      <img src="images/avatars/user-02.jpg" alt="Author 3" className="testimonials__avatar"/>
